<template>
  <div>
    <el-form
      ...
      label-width="120px"
    >
      <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' label="选择在线测试" prop="paperid">
      ...
      <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' label="试题" prop="questionname">
        <el-input
          type="textarea"
          min="1"
      ...
      <el-form-item :style='{"padding":"0","margin":"0"}'>
        <el-button :style='{"border":"0","cursor":"pointer","padding":"0","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"5px","background":"#458C8C","width":"128px","lineHeight":"40px","fontSize":"18px","height":"40px"}' type="primary" @click="onSubmit">提交</el-button>
        <el-button :style='{"border":"0px solid rgba(64, 158, 255, 1)","cursor":"pointer","padding":"0","margin":"0","outline":"none","color":"#fff","borderRadius":"5px","background":"#458C8C","width":"128px","lineHeight":"40px","fontSize":"18px","height":"40px"}' @click="back()">取消</el-button>
      </el-form-item>
    </el-form>
