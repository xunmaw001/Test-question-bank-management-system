<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="章节" prop="zhangjie">
					<el-input v-model="ruleForm.zhangjie" placeholder="章节" clearable  :readonly="ro.zhangjie"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="章节" prop="zhangjie">
					<el-input v-model="ruleForm.zhangjie" placeholder="章节" readonly></el-input>
				</el-form-item>
			</template>
