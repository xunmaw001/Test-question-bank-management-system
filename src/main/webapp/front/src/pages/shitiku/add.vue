...
<div :style='{"padding":"20px 20px 40px","margin":"10px auto 0","borderColor":"#52b646","borderRadius":"12px","background":"#fff","borderWidth":"3px","width":"1200px","position":"relative","borderStyle":"solid dashed double double"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="题库编号" prop="tikubianhao">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="章节" prop="zhangjie">
            <el-select v-model="ruleForm.zhangjie" placeholder="请选择章节"  >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="题目内容" prop="timuneirong">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="题目内容"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="答案" prop="daan">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="答案"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="重点分析" prop="zhongdianfenxi">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="重点分析"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="题目详情" prop="timuxiangqing">
            <editor 
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/kemu/kemu', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.kemuOptions = res.data.data;
          }
        });
        this.$http.get('option/zhangjie/zhangjie', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('shitiku/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
                  ...
                  params: params
                     ...
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('shitiku/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
